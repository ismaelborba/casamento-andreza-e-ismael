                        ...
                        <div className="col col-md-12 col-12">
                            <div className="couple-item-wrap pointparallax">
                                <div className="couple-img-wrap">
                                    <div className="couple-common point__item" data-position="left-top" data-point="middle" data-path="280">
                                        <div className="couple-img">
                                            <img src="/assets/images/couple/bride.png" alt="" />
                                        </div>
                                    </div>

                                    <div className="couple-common point__item" data-position="right" data-point="middle" data-path="280">
                                        <div className="couple-img">
                                ...
                                <div className="couple-common couple-text-wrap">
                                    <div className="couple-text-l-item">
                                        <div
                                            ...
                                            data-path="280"
                                        >
                                            <svg className="shape-bg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 667 413" fill="none">
                                                <path
                                            ...
                                            <div className="outer-shape">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 669 424" fill="none">
                                                    <path
                                            ...
                                            <div className="couple-text">
                                                <h3>Andreza Alves</h3>
                                                <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna orci auctor vitae nisl. Erat
                                                    fringilla pellentesque amet tempus. Commodo mi vitae, sagittis blandit.
                                                </p>
                                    ...
                                    <div className="couple-text-r-item">
                                        <div className="couple-text-bg point__item" data-position="left-bottom" data-point="right-bottom" data-path="280">
                                            <svg className="shape-bg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 591 440" fill="none">
                                                <path
